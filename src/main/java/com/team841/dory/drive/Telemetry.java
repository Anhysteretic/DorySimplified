...
public class Telemetry {
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        if (((state.ModuleStates[2].angle.getDegrees() % 360 + 360) % 360) > 180){
            DogLog.log("DriveState/AngleState", ((state.ModuleStates[2].angle.getDegrees() % 360 + 360) % 360) - 180);

        } else {
            DogLog.log("DriveState/AngleState", ((state.ModuleStates[2].angle.getDegrees() % 360 + 360) % 360));
        }

        if (((state.ModuleTargets[2].angle.getDegrees() % 360 + 360) % 360) > 180){

            DogLog.log("DriveState/AngleTarget", ((state.ModuleTargets[2].angle.getDegrees() % 360 + 360) % 360)-180);

        } else {
            DogLog.log("DriveState/AngleTarget", ((state.ModuleTargets[2].angle.getDegrees() % 360 + 360) % 360));
        }

        DogLog.log("DriveState/Pose", m_poseArray);
